...
CREATE OR REPLACE VIEW gastos.totais AS
    SELECT ano_transacao, mes_transacao, SUM(total) AS total, orgao_responsavel
    FROM (
             ...
             GROUP BY ano_transacao, mes_transacao, orgao.nome
    ...
    GROUP BY ano_transacao, mes_transacao, orgao_responsavel
    ORDER BY ano_transacao, mes_transacao, orgao_responsavel;
